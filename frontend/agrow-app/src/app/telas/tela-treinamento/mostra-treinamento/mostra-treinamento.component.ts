...
@Component({
  selector: 'app-mostra-treinamento',
  templateUrl: './mostra-treinamento.component.html',
  styleUrls: ['./mostra-treinamento.component.css']
})
export class MostraTreinamentoComponent implements OnInit {

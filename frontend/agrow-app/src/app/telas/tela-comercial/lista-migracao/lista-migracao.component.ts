...
@Component({
  selector: 'app-lista-migracao',
  templateUrl: './lista-migracao.component.html',
  styleUrls: ['./lista-migracao.component.css']
})
export class ListaMigracaoComponent implements OnInit {
